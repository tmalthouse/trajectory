...
static const char *UPDATEBODY = "UPDATE bodies SET semimajoraxis=?001, eccentricity=?002, inclination=?003, arg_of_periapsis=?004, long_ascend_node=?005, mean_ano_epoch=?006, time_since_epoch=?007 WHERE id=?008";
